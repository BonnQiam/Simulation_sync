...
VL_INLINE_OPT VlCoroutine VNorTestBench___024root___eval_initial__TOP__2(VNorTestBench___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 48, 0, VL_CVT_PACK_STR_NW(4, __Vtemp_1)
                 ,  &(vlSelf->NorTestBench__DOT__DataSource)
                 , 0, ~0ULL);
    ...
    vlSelf->NorTestBench__DOT__Write_Out_File = VL_FOPEN_MCD_N(
    ...
    co_await vlSelf->__VdlySched.delay(0x5dc0ULL, nullptr, 
                                       ...
                                       61);
    vlSelf->__Vm_traceActivity[2U] = 1U;
    vlSelf->NorTestBench__DOT__Data_out = vlSelf->NorTestBench__DOT__DataSource
        [0x2fU];
    ...
    VL_FWRITEF(vlSelf->NorTestBench__DOT__Write_Out_File,"@%x\n%x\n",
               6,vlSelf->NorTestBench__DOT__Mpi_addr,
               8,(IData)(vlSelf->NorTestBench__DOT__Data_in));
    VL_WRITEF("Addr: %x -> DataRead: %x\n------------------------\n",
              6,vlSelf->NorTestBench__DOT__Mpi_addr,
              8,(IData)(vlSelf->NorTestBench__DOT__Data_in));
    co_await vlSelf->__VdlySched.delay(0x1770ULL, nullptr, 
                                       "NorTestBench.v", 
    ...
    VL_FCLOSE_I(vlSelf->NorTestBench__DOT__Write_Out_File); VL_STOP_MT("NorTestBench.v", 111, "");
    vlSelf->__Vm_traceActivity[2U] = 1U;
}
